...
import net.maxitheslime.twosidesmod.screen.renderer.EnergyDisplayTooltipArea;
import net.maxitheslime.twosidesmod.screen.renderer.FluidTankRenderer;
import net.maxitheslime.twosidesmod.util.MouseUtil;
...
public class PurificationTableScreen extends AbstractContainerScreen<PurificationTableMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(TwoSidesMod.MOD_ID,"textures/gui/purification_table_gui.png");
    private EnergyDisplayTooltipArea energyInfoArea;
    private FluidTankRenderer fluidRenderer;

    public PurificationTableScreen(PurificationTableMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
