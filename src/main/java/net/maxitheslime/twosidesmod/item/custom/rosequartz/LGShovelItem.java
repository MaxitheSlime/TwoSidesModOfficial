...
public class LGShovelItem extends ShovelItem {
    public LGShovelItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
