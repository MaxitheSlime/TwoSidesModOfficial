...
public class LGHammerItem extends HammerItem {
    public LGHammerItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
