...
public class ElementalPaxelItem extends PaxelItem {
    public ElementalPaxelItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
