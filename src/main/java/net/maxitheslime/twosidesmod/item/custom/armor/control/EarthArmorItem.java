...
public class EarthArmorItem extends ArmorItem implements GeoItem
{
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> EARTH_ARMOR_EFFECT1 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.CONTROL_EARTH, new MobEffectInstance(ModEffects.ROCK_TOMB.get(), 200, 0))
                    .build();
    private static final Map<ArmorMaterial, MobEffectInstance> EARTH_ARMOR_EFFECT2 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.CONTROL_EARTH, new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 200, 1))
                    .build();

    public EarthArmorItem(ArmorMaterial armorMaterial, Type type, Properties properties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new EarthArmorRenderer();
    ...
    private void evaluateArmorEffects(Player player) {
        for(Map.Entry<ArmorMaterial, MobEffectInstance> entry : EARTH_ARMOR_EFFECT1.entrySet()) {
        ...
        for(Map.Entry<ArmorMaterial, MobEffectInstance> entry : EARTH_ARMOR_EFFECT2.entrySet()) {
            ArmorMaterial mapArmorMaterial = entry.getKey();
            MobEffectInstance mapEffect = entry.getValue();
