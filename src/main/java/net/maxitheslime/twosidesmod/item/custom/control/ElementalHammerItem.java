...
public class ElementalHammerItem extends HammerItem {
    public ElementalHammerItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
