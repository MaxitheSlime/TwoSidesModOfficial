...
import net.maxitheslime.twosidesmod.util.InventoryUtil;
...
public class MetalDetectorItem extends Item {
    ...
    private void addDataToDataTablet(Player player, BlockPos below, Block block) {
        ...
        data.putString("twosidesmod.found_ore","Valuable Found: " + I18n.get(block.getDescriptionId())
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if(Screen.hasShiftDown()){
            pTooltipComponents.add(Component.translatable
                    ("tooltip.twosidesmod.metal_detector.tooltip.shift"));
        } else {
            pTooltipComponents.add(Component.translatable
                    ("tooltip.twosidesmod.metal_detector.tooltip"));
        }
    }
