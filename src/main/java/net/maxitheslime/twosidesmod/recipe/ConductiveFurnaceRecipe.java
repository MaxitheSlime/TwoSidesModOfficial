...
public class ConductiveFurnaceRecipe extends AbstractCookingRecipe {
    public ConductiveFurnaceRecipe(ResourceLocation pId, String pGroup,
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(ModBlocks.CONDUCTIVE_FURNACE.get());
    }
    ...
    public static class Type implements RecipeType<ConductiveFurnaceRecipe> {
        public static final Type INSTANCE = new Type();
    }

    public static class Serializer implements RecipeSerializer<ConductiveFurnaceRecipe> {
        ...
        public ConductiveFurnaceRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new ConductiveFurnaceRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public ConductiveFurnaceRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        public void toNetwork(FriendlyByteBuf pBuffer, ConductiveFurnaceRecipe pRecipe) {
