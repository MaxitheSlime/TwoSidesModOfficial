    ...
    public static final RegistryObject<CreativeModeTab> TWO_SIDES_TOOLS = CREATIVE_MODE_TABS.register("two_sides_tools",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.METAL_DETECTOR.get())).
                    title(Component.translatable("creativetab.two_sides_tools")).displayItems((pParameters, pOutput) ->
                    {
                        ...
                        pOutput.accept(ModItems.LIFE_SWORD.get());
                        pOutput.accept(ModItems.LIFE_PICKAXE.get());
                        pOutput.accept(ModItems.LIFE_SHOVEL.get());
                        pOutput.accept(ModItems.LIFE_AXE.get());
                        pOutput.accept(ModItems.LIFE_HOE.get());
                        pOutput.accept(ModItems.LIFE_PAXEL.get());
                        pOutput.accept(ModItems.LIFE_HAMMER.get());
                        pOutput.accept(ModItems.LIFE_BOW.get());
                        pOutput.accept(ModItems.LIFE_HELMET.get());
                        pOutput.accept(ModItems.LIFE_CHESTPLATE.get());
                        pOutput.accept(ModItems.LIFE_LEGGINGS.get());
